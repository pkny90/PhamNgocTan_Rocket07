...
public class Main {
	...
	public static void main(String[] args) {
		...
		Position position1 = new Position(PositionName.Dev, 1);
		Position position2 = new Position(PositionName.Test, 2);
		...
		Group group3 = new Group("ASP.Net", 3);
		...
		TypeQuestion typeQuestion1 = new TypeQuestion(TypeName.Essay, 1);
		TypeQuestion typeQuestion2 = new TypeQuestion(TypeName.MULTIPLE_CHOICES, 2);

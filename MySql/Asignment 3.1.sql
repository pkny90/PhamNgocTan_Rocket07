...
ORDER BY 	Fullname DESC; -- DESC: sắp xếp theo thứ tự giảm dần ngược với ASC
...
DELETE 
FROM 		`Account`
WHERE 		(SUBSTRING_INDEX(FullName,' ',2)) = 'Bui Xuan';
...
-- Xóa hết (dữ liệu khi DepartmentID = 1) ở cột Account
Delete
from `account`
where `departmentID` = 2;
...
-- Đổi fullname ở cột account nơi DepartmentID = 1 thành 'Tan'
Update `account`
set Fullname = 'Tan'
